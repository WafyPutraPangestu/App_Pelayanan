<x-layout>
    <h1>HALAMAN EDIT SURAT DOMISILI</h1>
    <div class="max-w-5xl mx-auto bg-white p-8 rounded-xl shadow-lg border border-gray-200">

        {{-- Menampilkan Nomor Surat --}}
        <div class="mb-6 pb-4 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-800">Nomor Surat: {{ $suratDomisili->nomor_surat }}</h3>
            <p class="text-sm text-gray-500">Status Saat Ini: <span class="font-medium text-blue-600">{{ ucwords($suratDomisili->status) }}</span></p>
        </div>
