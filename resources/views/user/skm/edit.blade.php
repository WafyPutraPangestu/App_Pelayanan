    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto">
            <h1 class="text-3xl font-extrabold text-gray-900 mb-8 text-center tracking-tight" x-data="{ show: false }" x-init="$nextTick(() => show = true)" x-show="show" x-transition:enter="transition ease-out duration-500" x-transition:enter-start="opacity-0 transform -translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0">
                Edit Formulir Surat Keterangan Kematian (SKM)
            </h1>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8" x-data="{ show: false }" x-init="$nextTick(() => show = true)" x-show="show" x-transition:enter="transition ease-out duration-700" x-transition:enter-start="opacity-0 transform scale-95" x-transition:enter-end="opacity-100 transform scale-100">
                <form action="{{ route('skm.update', $skm->id) }}" method="POST">
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="nama_almarhum" value="{{ old('nama_almarhum', $skm->nama_almarhum) }}" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200">
                            ...
                            <div>
                                ...
                                <input type="text" name="nik_almarhum" value="{{ old('nik_almarhum', $skm->nik_almarhum) }}" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="tempat_lahir_almarhum" value="{{ old('tempat_lahir_almarhum', $skm->tempat_lahir_almarhum) }}" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="tanggal_lahir_almarhum" value="{{ old('tanggal_lahir_almarhum', $skm->tanggal_lahir_almarhum->format('Y-m-d')) }}" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="agama_almarhum" value="{{ old('agama_almarhum', $skm->agama_almarhum) }}" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="date" name="tanggal_kematian" value="{{ old('tanggal_kematian', $skm->tanggal_kematian->format('Y-m-d')) }}" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200">
                                ...
                                <div>
                                    ...
                                    <input type="time" name="waktu_kematian" value="{{ old('waktu_kematian', $skm->waktu_kematian->format('H:i')) }}" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200">
                            ...
                            <div>
                                ...
                                <input type="text" name="penyebab_kematian" value="{{ old('penyebab_kematian', $skm->penyebab_kematian) }}" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200" placeholder="Sakit/Kecelakaan/dll">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="alamat_almarhum" rows="4" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200">{{ old('alamat_almarhum', $skm->alamat_almarhum) }}</textarea>
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="nama_pelapor" value="{{ old('nama_pelapor', $skm->pelaporKematian->nama_pelapor) }}" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200">
                            ...
                            <div>
                                ...
                                <input type="text" name="nik_pelapor" value="{{ old('nik_pelapor', $skm->pelaporKematian->nik_pelapor) }}" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="tempat_lahir_pelapor" value="{{ old('tempat_lahir_pelapor', $skm->pelaporKematian->tempat_lahir_pelapor) }}" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="tanggal_lahir_pelapor" value="{{ old('tanggal_lahir_pelapor', $skm->pelaporKematian->tanggal_lahir_pelapor->format('Y-m-d')) }}" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="pekerjaan_pelapor" value="{{ old('pekerjaan_pelapor', $skm->pelaporKematian->pekerjaan_pelapor) }}" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200">
                            ...
                            <div>
                                ...
                                <input type="text" name="hubungan_dengan_almarhum" value="{{ old('hubungan_dengan_almarhum', $skm->pelaporKematian->hubungan_dengan_almarhum) }}" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200" placeholder="Anak/Istri/Suami/dll">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="alamat_pelapor" rows="4" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200">{{ old('alamat_pelapor', $skm->pelaporKematian->alamat_pelapor) }}</textarea>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200 flex justify-end">
                        <button type="submit" class="bg-indigo-600 text-white px-6 py-3 rounded-lg hover:bg-indigo-700 transition duration-200 font-medium">Update Pengajuan</button>
                    </div>
                </form>
            </div>
        </div>
