<x-layout>
    <h1 class="text-2xl font-bold text-gray-800 mb-6 text-center">Formulir Surat Keterangan Kematian (SKM)</h1>
        ...
        <form action="{{ route('skm.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                 <div>
                    ...
                    <input type="text" name="nama_almarhum" value="{{ old('nama_almarhum') }}" class="w-full form-input">
                ...
                <div>
                    ...
                    <input type="text" name="nik_almarhum" value="{{ old('nik_almarhum') }}" class="w-full form-input">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="tempat_lahir_almarhum" value="{{ old('tempat_lahir_almarhum') }}" class="w-full form-input">
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_lahir_almarhum" value="{{ old('tanggal_lahir_almarhum') }}" class="w-full form-input">
                 ...
                 <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="agama_almarhum" value="{{ old('agama_almarhum') }}" class="w-full form-input">
                 ...
                 <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" name="tanggal_kematian" value="{{ old('tanggal_kematian') }}" class="w-full form-input">
                    ...
                    <div>
                        ...
                        <input type="time" name="waktu_kematian" value="{{ old('waktu_kematian') }}" class="w-full form-input">
                ...
                <div>
                    ...
                    <input type="text" name="penyebab_kematian" value="{{ old('penyebab_kematian') }}" class="w-full form-input" placeholder="Sakit/Kecelakaan/dll">
                 ...
                 <div class="md:col-span-2">
                    ...
                    <textarea name="alamat_almarhum" rows="3" class="w-full form-input">{{ old('alamat_almarhum') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                <div>
                    ...
                    <input type="text" name="nama_pelapor" value="{{ old('nama_pelapor') }}" class="w-full form-input">
                ...
                <div>
                    ...
                    <input type="text" name="nik_pelapor" value="{{ old('nik_pelapor') }}" class="w-full form-input">
                ...
                <div class="grid grid-cols-2 gap-4">
                     <div>
                        ...
                        <input type="text" name="tempat_lahir_pelapor" value="{{ old('tempat_lahir_pelapor') }}" class="w-full form-input">
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_lahir_pelapor" value="{{ old('tanggal_lahir_pelapor') }}" class="w-full form-input">
                 ...
                 <div class="grid grid-cols-2 gap-4">
                     ...
                     <div>
                        ...
                        <input type="text" name="pekerjaan_pelapor" value="{{ old('pekerjaan_pelapor') }}" class="w-full form-input">
                 ...
                 <div>
                    ...
                    <input type="text" name="hubungan_dengan_almarhum" value="{{ old('hubungan_dengan_almarhum') }}" class="w-full form-input" placeholder="Anak/Istri/Suami/dll">
                 ...
                 <div class="md:col-span-2">
                    ...
                    <textarea name="alamat_pelapor" rows="3" class="w-full form-input">{{ old('alamat_pelapor') }}</textarea>
