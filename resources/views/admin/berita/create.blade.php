<x-layout>
    <div x-data="beritaForm()" x-init="init()">
        <!-- Toast Notification -->
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600">Buat berita baru untuk dipublikasikan di website</p>
                </div>
        ...
        <!-- Form -->
        <div class="max-w-4xl">
            <form action="{{ route('berita.store') }}" method="POST" enctype="multipart/form-data" @submit="onSubmit">
                @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select 
                                    ...
                                    <option value="0" {{ old('dipublikasikan', '0') == '0' ? 'selected' : '' }}>Draft</option>
                                    <option value="1" {{ old('dipublikasikan') == '1' ? 'selected' : '' }}>Publikasikan</option>
                                </select>
