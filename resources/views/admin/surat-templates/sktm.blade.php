...
<head>
    <meta charset="UTF-8">
    <title>Surat Keterangan Tidak Mampu - {{ $surat->nomor_surat }}</title>
    <style>
...
<body>
    <div class="container">
        ...
        <table class="data-pemohon">
            <tr><td style="width:30%">Nama Lengkap</td><td style="width:5%">:</td><td><strong>{{ $surat->nama }}</strong></td></tr>
        ...
        <p class="paragraf">Berdasarkan data dan sepengetahuan kami, nama tersebut di atas adalah benar penduduk Desa Sukanagara dan tergolong dalam keluarga kurang mampu.</p>
