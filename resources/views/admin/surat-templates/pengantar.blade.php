...
<body>
    <div class="container">
        ...
        <p class="paragraf">Yang bertanda tangan di bawah ini, Kepala Desa Sukanagara Jaya, Kecamatan Cikupa, Kabupaten Tangerang, dengan ini memberikan pengantar kepada:</p>

        <table class="data-pemohon">
            <tr><td style="width:30%">Nama Lengkap</td><td style="width:5%">:</td><td><strong>{{ $surat->user->name }}</strong></td></tr>
        ...
        <p class="paragraf">Untuk keperluan: <strong>{{ $surat->maksud_dan_tujuan }}</strong>.</p>
        <p class="paragraf">Surat pengantar ini berlaku selama 1 (satu) bulan sejak tanggal diterbitkan.</p>
