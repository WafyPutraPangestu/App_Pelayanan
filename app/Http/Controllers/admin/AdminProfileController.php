...
{
    /**
     * Display the admin's profile page with editable form.
     */
    public function index()
    {
        ...
        return view('admin.profile.index', compact('user', 'biodata'));
    }

    /**
     * Update the admin's profile and biodata in storage.
     */
